...
# Makes a request with the first account, then moves to the second, etc. Can
# quickly move through the followers, when given a large number of accounts to
# work with
